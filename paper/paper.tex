...
\end{lstlisting}
  ...
  We obtained the list of all \code{npm} package names from the \code{npm} registry skimdb\footnote{\url{https://skimdb.npmjs.com/registry/_all_docs}}, and then %TODO fix this footnote, underscores are cursed
