...
\begin{table}
  ...
  % TODO NOTE THAT THIS HAS LOWER NUMBERS THAN THE ORIGINAL PAPER DUE TO MONTHLY PAGERANKS
  \begin{tabular}{c|c|c|c}
    Keyword & "\code{npm} strong" & "\code{GitHub} strong" & Diff. \\
    \hline
     & - & 0.550 & 0.345\\
     & 0.550 & - & 0.444\\
     & 0.345 & 0.444 & -\\
  ...
  \end{tabular}
  \caption{"\code{npm} strong" keywords ordered by difference in occurrence between correlated measures.}
  \label{npmStrong}
\end{table}
...
\begin{table}
  ...
  % TODO NOTE THAT THIS HAS LOWER NUMBERS THAN THE ORIGINAL PAPER DUE TO MONTHLY PAGERANKS
  \begin{tabular}{c|c|c|c}
    Keyword  & "\code{GitHub} strong" & "\code{npm} strong" & Diff. \\
    \hline
     & - & 0.550 & 0.345\\
     & 0.550 & - & 0.444\\
     & 0.345 & 0.444 & -\\
  ...
  \end{tabular}
  \caption{"\code{GitHub} strong" keywords ordered by difference in occurrence between correlated measures.}
  \label{githubStrong}
\end{table}


Tables \ref{npmStrong} and \ref{githubStrong} display keywords most strongly associated with
a single popularity ranking. As the keywords in Table \ref{npmStrong} are closely linked to 
